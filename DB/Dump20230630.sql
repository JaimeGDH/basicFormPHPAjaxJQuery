...
/*!40103 SET @OLD_TIME_ZONE=@@TIME_ZONE */;-- MySQL dump 10.13  Distrib 8.0.33, for Linux (x86_64)
--
-- Host: localhost    Database: desis
-- ------------------------------------------------------
-- Server version	8.0.33
...
CREATE TABLE `candidatos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=346 DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `candidatos` VALUES (1,'Juan Pérez','22067914-4'),(2,'José Soto','8686718-4'),(3,'Andrés González','20704496-2');
...
INSERT INTO `regiones` VALUES (1,'Arica y Parinacota','AP','Arica'),(2,'Tarapacá','TA','Iquique'),(3,'Antofagasta','AN','Antofagasta'),(4,'Atacama','AT','Copiapó'),(5,'Coquimbo','CO','La Serena'),(6,'Valparaiso','VA','valparaíso'),(7,'Metropolitana de Santiago','RM','Santiago'),(8,'Libertador General Bernardo O\'Higgins','OH','Rancagua'),(9,'Maule','MA','Talca'),(10,'Ñuble','NB','Chillán'),(11,'Biobío','BI','Concepción'),(12,'La Araucanía','IAR','Temuco'),(13,'Los Ríos','LR','Valdivia'),(14,'Los Lagos','LL','Puerto Montt'),(15,'Aysén del General Carlos Ibáñez del Campo','AI','Coyhaique'),(16,'Magallanes y de la Antártica Chilena','MG','Punta Arenas');
...
) ENGINE=MyISAM AUTO_INCREMENT=350 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-30 16:41:11
/*!40103 SET TIME_ZONE='+00:00' */;
/*!40014 SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0 */;
/*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */;
/*!40101 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO' */;
